...
reference_Sze_inner = np.array([
    np.array([1.305, 2.455, 3.435, 4.277, 5.007, 5.649, 6.725, 7.602, 8.34, 8.974, 
        9.529, 10.023, 10.468, 10.876, 11.257, 11.620, 11.97, 12.31, 12.642, 12.966, 13.282, 13.59, 13.891]),
    0.8*np.array([.025, .05,.075, .1, .125, .15, .2, .25, .3, .35, .4, .45, .5, .55, 
        .6, .65, .7, .75, .8, .85, .9, .95, 1.])
    ])
reference_Sze_outer = np.array([
    np.array([1.789, 3.370, 4.720, 5.876, 6.872, 7.736, 9.160, 10.288, 11.213, 11.992, 12.661,
        13.247, 13.768, 14.240, 14.674, 15.081, 15.469, 15.842, 16.202, 16.550, 16.886, 17.212, 17.528]),
    0.8*np.array([.025, .05,.075, .1, .125, .15, .2, .25, .3, .35, .4, .45, .5, .55, 
        .6, .65, .7, .75, .8, .85, .9, .95, 1.])
    ])
plt.plot(wlistA, loadings,  "x", color='green', label=r'$w_{hA}$')
plt.plot(wlistB, loadings,  "o", color='r', label=r'$w_{hB}$')
