...
def psi_M(k, **kwargs):
    ...
    if 'E' in kwargs and 't' in kwargs and 'nu' in kwargs:
        ...
        raise ArgumentError("Invalid set of kwargs to specify bending energy density.")
...
def psi_N(e, **kwargs):
    ...
    if 'E' in kwargs and 't' in kwargs and 'nu' in kwargs:
        ...
        raise ArgumentError("Invalid set of kwargs to specify membrane stress tensor.")
